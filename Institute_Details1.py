...
if os.path.exists('Institute_Details.csv') == False :
    df.to_csv("Institute_Details.csv", index=False)
else:
    df.to_csv("Institute_Details.csv", index=False, mode='a',header=False)